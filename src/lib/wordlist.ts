// A secure curated list of 2000+ words derived from the BIP39 standard
// Used for high-entropy passphrase generation.
...
export const wordlist = [
    ...
    "lizard", "load", "loan", "logic", "logo", "lonely", "long", "look", "loop", "lottery",
    ...
    "stage", "stairs", "stamp", "stand", "star", "start", "state", "save", "station", "statue",
    "status", "stay", "steak", "steel", "stem", "step", "stereo", "stick", "still", "sting",
    ...
    "weed", "week", "weigh", "weight", "welcome", "west", "wet", "whale", "what", "wheat",
