...
export function AdvancedEncryptionTool() {
    ...
    return (
        <div className="w-full max-w-5xl mx-auto">
            ...
            <div className="bg-card/70 backdrop-blur-2xl border border-border/50 rounded-3xl p-6 md:p-10 dark:shadow-[0_8px_30px_rgba(0,0,0,0.5)] shadow-[0_8px_30px_rgba(0,0,0,0.05)] relative overflow-hidden group">
